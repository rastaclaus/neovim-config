		...
		local conf = {
			...
			agents = {
				...
				},
				{
					...
					chat = true,
					command = true,
					model = { model = "gpt-4.1", temperature = 0.7, top_p = 1 },
					system_prompt = tech_writer_prompt,
				},
				{
					provider = "openai",
					name = "writer-gpt-4.1-mini",
					chat = true,
					command = true,
				...
				{
					provider = "openai",
					name = "writer-gemini-2.5-flash-preview",
					chat = true,
					command = true,
					model = { model = "gemini-2.5-flash-preview", temperature = 0.7, top_p = 1 },
				...
				{
					provider = "openai",
					name = "code-gemini-2.5-flash-preview",
					chat = true,
					command = true,
					model = { model = "gemini-2.5-flash-preview", temperature = 0.2, top_p = 1 },
					system_prompt = code_prompt,
				},
				{
					provider = "openai",
				...
				{
					provider = "openai",
					name = "code-gpt-4.1-mini",
					chat = true,
					command = true,
					model = { model = "gpt-4.1-mini", temperature = 0.2, top_p = 1 },
					system_prompt = code_prompt,
				},
				{
					provider = "openai",
					...
					chat = true,
					command = true,
					model = { model = "gpt-4.1", temperature = 0.2, top_p = 1 },
					system_prompt = code_prompt,
				},
				---Models for translation
				{
					provider = "openai",
					name = "translate-gemini-2.5-flash-preview",
					chat = true,
					command = true,
					model = { model = "gemini-2.5-flash-preview", temperature = 0.3, top_p = 1 },
					system_prompt = translate_prompt,
				},
				{
					provider = "openai",
					name = "translate-gpt-4.1-mini",
					chat = true,
					command = true,
					model = { model = "gpt-4.1-mini", temperature = 0.3, top_p = 1 },
					system_prompt = translate_prompt,
				},
			},
		}
